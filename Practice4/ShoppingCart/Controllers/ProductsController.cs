...
namespace ShoppingCart.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Code,Name,ListPrice,PurchasePrice,Year,Description,MarkId,CategoryId,Ofert,OfetPrice,Picture,Rating,Weight,Height,ExpirationDate,MinStock,MaxStock,SupplierId,Enable,CreatedBy")] Product product, HttpPostedFileBase file)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Code,Name,ListPrice,PurchasePrice,Year,Description,MarkId,CategoryId,Ofert,OfetPrice,Picture,Rating,Weight,Height,ExpirationDate,MinStock,MaxStock,SupplierId,Enable,CreatedBy")] Product product)
        {
            if (ModelState.IsValid)
            {
                product.CreatedDate = DateTime.Now;
